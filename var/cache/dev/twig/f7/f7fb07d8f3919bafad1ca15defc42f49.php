...
class __TwigTemplate_70e5309e2c57d7e13ec6fdf3598e0301 extends Template
{
    private $source;
    private $macros = [];
...
<h1>Modification d'un menu</h1>
        ...
        echo "
            ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "formules", [], "any", false, false, false, 14), 'row');
        echo "
            ";
        // line 15
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "request", [], "any", false, false, false, 15), "attributes", [], "any", false, false, false, 15), "get", [0 => "_route"], "method", false, false, false, 15) == "admin_menu_edit")) {
            // line 16
            echo "                ";
...
";
    ...
    {
        return array (  150 => 27,  142 => 23,  139 => 22,  128 => 19,  124 => 18,  121 => 17,  116 => 16,  114 => 15,  110 => 14,  106 => 13,  102 => 12,  98 => 11,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Admin - Modifier menu{% endblock %}
