...
class __TwigTemplate_1ab1d636776ce2def7e032158693b969 extends Template
{
    private $source;
    private $macros = [];
...
{% block title %}Email Récupération mot de passe{% endblock %}
...
<div class=\"container\">
    <div class=\"card\">
        <div class=\"card-body\">
            ...
            <p>Si vous ne recevez pas ce mail, vérifier votre dossier Spam ou <a href=\"{{ path('app_forgot_password_request') }}\">essayer de nouveau</a>.</p>
...
{% endblock %}
", "reset_password/check_email.html.twig", "C:\\xampp\\htdocs\\QuaiAntique-AG\\templates\\reset_password\\check_email.html.twig");
    }
}
