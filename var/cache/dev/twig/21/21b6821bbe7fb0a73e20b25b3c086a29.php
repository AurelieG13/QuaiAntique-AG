...
class __TwigTemplate_c44d127a4d26a2df9e7494e8b255fce4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  111 => 18,  104 => 14,  99 => 12,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Administration - Catégories - Ajouter{% endblock %}
...
<h1>Ajout d'une categorie</h1>
        <section>
                <a href=\"{{ path('admin_category_list') }}\" type=\"button\" class=\"btn btn-custom my-3\">Retour</a>
        </section>
        {{ form_start(form)}}
