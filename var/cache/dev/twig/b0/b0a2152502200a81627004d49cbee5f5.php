...
class __TwigTemplate_468f70cc1eb0bd359660fabd23f3c3fe extends Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["hour"]) {
            ...
            echo "\" type=\"button\" class=\"btn btn-warning\">
              ...
              <td>
              <a href=\"#\" type=\"button\" class=\"btn btn-danger modal-trigger-hour\" data-bs-toggle=\"modal\" data-bs-target=\"#modal-delete-hour\" data-id=\"";
            // line 51
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["hour"], "id", [], "any", false, false, false, 51), "html", null, true);
            echo "\" data-titre = \"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["hour"], "id", [], "any", false, false, false, 51), "html", null, true);
            echo "\">
                  Supprimer
...
";
    ...
    {
        return array (  186 => 57,  172 => 51,  164 => 46,  156 => 41,  150 => 38,  146 => 37,  142 => 36,  138 => 35,  134 => 34,  130 => 33,  127 => 32,  123 => 31,  102 => 13,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
