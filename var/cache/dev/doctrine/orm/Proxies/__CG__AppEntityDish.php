 ...
 */
class Dish extends \App\Entity\Dish implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'activeHome' => [parent::class, 'activeHome', null],
        ...
        'activeHome' => [parent::class, 'activeHome', null],
