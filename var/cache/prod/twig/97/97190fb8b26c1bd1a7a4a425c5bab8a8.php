...
class __TwigTemplate_c42634b14261e9f7417a550872e7a0d3 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 12
        echo "    ";
        if ((twig_length_filter($this->env, ($context["params"] ?? null)) > 0)) {
            // line 13
            echo "        ";
            $context['_parent'] = $context;
    ...
    <button>";
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "button", [], "any", false, false, false, 19), "html", null, true);
        echo "</button>
...
";
    ...
    {
        return array (  111 => 19,  103 => 17,  100 => 16,  89 => 14,  84 => 13,  81 => 12,  73 => 10,  69 => 8,  54 => 6,  50 => 5,  45 => 4,  43 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@KnpPaginator/Pagination/filtration.html.twig", "C:\\xampp\\htdocs\\QuaiAntique-AG\\vendor\\knplabs\\knp-paginator-bundle\\templates\\Pagination\\filtration.html.twig");
    }
}
