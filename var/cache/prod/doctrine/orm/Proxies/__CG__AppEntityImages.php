 ...
 */
class Images extends \App\Entity\Images implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'dishes' => [parent::class, 'dishes', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        "\0".parent::class."\0".'menus' => [parent::class, 'menus', null],
        "\0".parent::class."\0".'name' => [parent::class, 'name', null],
        'dishes' => [parent::class, 'dishes', null],
