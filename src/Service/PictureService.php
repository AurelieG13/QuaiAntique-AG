...
class PictureService
{
    ...
    public function add(UploadedFile $picture, ?string $folder = '', ?int $width = 250, ?int $height = 250)
    {
        ...
        //on récupère les infos de taille de l'image
        ...
        //on vérifie le format de l'img (si c'est du jpg, autre)
        ...
        // controle de l'orientation de l'image (portrait/paysage)
        ...
        //on créé la nouvelle image vierge
